        ...
        e = function() {
            function e(n) {
                ...
                if (this.bursts = [], this.setCount = function(t) {
                        ...
                        function confettiEffect(t) {
                            var n = new o(2 * t.clientX, 2 * t.clientY); 
                            r.bursts.push(new i(n)), 
                            e.CONFIG.destroy_target && (r.element.style.visibility = "hidden");
                            r.element.removeEventListener("mouseenter", confettiEffect);
                        }
                        function reattachConfettiEffect() {
                            r.element.addEventListener("mouseenter", confettiEffect);
                        }
                        null === (n = r.element) || void 0 === n || n.addEventListener("mouseenter", confettiEffect);
                        r.element.addEventListener("mouseleave", reattachConfettiEffect);
